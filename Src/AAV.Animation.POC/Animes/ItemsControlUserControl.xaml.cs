...
namespace AAV.Animation.POC
{
    ...
    {
        ViewModel _vm;
        ObservableCollection<TaskTodo> _lst;
        ...
        public static readonly DependencyProperty ValProperty = DependencyProperty.Register("Val", typeof(double), typeof(ItemsControlUserControl), new PropertyMetadata(1d, new PropertyChangedCallback(onChanged))); public double Val { get { return (double)GetValue(ValProperty); } set { SetValue(ValProperty, value); } }
        public static readonly DependencyProperty AnmProperty = DependencyProperty.Register("Anm", typeof(double), typeof(ItemsControlUserControl), new PropertyMetadata(1d)); public double Anm { get { return (double)GetValue(AnmProperty); } set { SetValue(AnmProperty, value); } }
        public static readonly DependencyProperty UpYProperty = DependencyProperty.Register("UpY", typeof(double), typeof(ItemsControlUserControl), new PropertyMetadata(1d)); public double UpY { get { return (double)GetValue(UpYProperty); } set { SetValue(UpYProperty, value); } }
        ...
        static DoubleAnimation _daX = new DoubleAnimation { Duration = new Duration(TimeSpan.FromSeconds(.4)), EasingFunction = new BounceEase { Bounciness = 7 } };
        static DoubleAnimation _daY = new DoubleAnimation { Duration = new Duration(TimeSpan.FromSeconds(.2)), EasingFunction = new SineEase(), AutoReverse = true };
    }
}