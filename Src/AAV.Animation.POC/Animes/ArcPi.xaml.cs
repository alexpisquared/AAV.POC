...
public partial class ArcPi : UserControl
{
  ...
  void PropertyChangedCallback2(double anglePercent) => ArcHelper.DrawArc(arc_path, new Point(Radiu, Radiu), Radiu - (arc_path.StrokeThickness / 2), 0, anglePercent * Math.PI * .02);
}